...
/**
 * <p>
 * Utility class for color. Sections of this class are directly copied from com.badlogic.gdx.graphics.Color
 * </p>
 * 
...
public class Color {
    ...
    public static final Color RED = new Color(0xFF0000FF), BLUE = new Color(0x0000FFFF), GREEN = new Color(0x00FF00FF),
        BLACK = new Color(0x000000FF), WHITE = new Color(0xFFFFFFFF), ORANGE = new Color(0xFF8A00FF),
        HIGHLIGHT_LIGHT = new Color(0xFFFFFF55), HIGHLIGHT_DARK = new Color(0x00000044);
